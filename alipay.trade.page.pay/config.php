...
$config = array (	
		...
		//异步通知地址
		'notify_url' => "http://iruofeng.cn/bazicesuan/alipay.trade.page.pay/notify_url.php",
		
		//同步跳转
		'return_url' => "http://iruofeng.cn/bazicesuan/alipay.trade.page.pay/return_url.php",
