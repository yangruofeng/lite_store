...
class jpushApi {
    ...
    /*   !!!! extras里面需要固定几个字段
     *
     *   type  有没有消息记录的  1  有  -1 没有
     *
     *   message_id  后台消息的ID，没有值为0
     *
     *   notice_type  通知类型，项目自定义的，用来处理一些特殊的操作
     *
     * */
    ...
    public function sendPushOfForceLogout($member_id,$messageContent,$extras=array())
    {
        $extras = array_merge(array(
            'type' => -1,
            'notice_type' => '',
