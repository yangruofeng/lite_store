            ...
            <div id="login_top_right">
                <form class="form-signin form-horizontal" id="login-form">
                    ...
                    <div class="login-account">
                        <input type="text" class="form-control" placeholder="账号" name="user_code" value=""
                               autofocus>
                    ...
                    <div class="login-submit">
                        <button id="btn_signin" class="btn btn-warning btn-block" type="button" onclick="login();">
                            登录
                        </button>
                    </div>
                </form>
...
<script>
    ...
    function login() {
        ...
        var _data = getFormJson('#login-form');
        console.log(_data);
