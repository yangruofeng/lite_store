...
define('SITE_ROOT_URL',$config['site_root']);
...
define('BACK_OFFICE_SITE_URL', $config['project_site_url'] . DS . 'admin');
...
define('PROJECT_RESOURCE_SITE_URL', $config['project_site_url'] );
...
define('DESKTOP_SITE_URL',$config['project_site_url'].'/desktop');
