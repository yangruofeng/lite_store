...
<head>
    ...
    <link href="<?php echo BACK_OFFICE_SITE_URL?>/resource/css/main-style.css?v=31" rel="stylesheet" type="text/css"/>
...
<script src="<?php echo BACK_OFFICE_SITE_URL; ?>/resource/script/common.js?v=6"></script>
<?php require_once(template("widget/yo.dialog")); ?>
<script>
    yo.dynamicTplOfAdmin = function(param){
        param.control = param.control?param.control:'admin_base';
        yo.dynamicTpl(param);
    };
</script>
