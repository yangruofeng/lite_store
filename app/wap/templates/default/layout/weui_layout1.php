...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo PROJECT_RESOURCE_SITE_URL;?>/resource/weui/page.css?v=<?php echo time()?>">
    <link rel="stylesheet" type="text/css" href="<?php echo PROJECT_RESOURCE_SITE_URL;?>/resource/weui/weui.css?v=<?php echo time()?>">
    <link rel="stylesheet" type="text/css" href="<?php echo PROJECT_RESOURCE_SITE_URL;?>/resource/weui/weui.extend.css?v=<?php echo time()?>">
    ...
    <script type="text/javascript">
        ...
        function alert(_msg,callback){
            showWeuiDialog(_msg,callback);
        }
        function showWeuiDialog(_msg,callback){
            $("#iosDialog").find(".weui-dialog__bd").html(_msg);
            $("#iosDialog").fadeIn(200);
            $("#iosDialog").find(".btn-got-it").unbind("click");
            if($.isFunction(callback)){
                $("#iosDialog").find(".btn-got-it").bind("click",callback);
            }
        }
