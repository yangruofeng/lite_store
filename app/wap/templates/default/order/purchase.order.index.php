    ...
    <div class="weui-tab">
        ...
        <div class="weui-tab__bd">
            ...
            <div class="button-sp-area cell" style="margin-top: 5px;">
                <a href="<?php echo getWapUrl('order','addPurchaseOrder'); ?>" class="weui-btn weui-btn_primary">
                    ...
                    <div class="weui-form-preview">
                        <div class="weui-form-preview__hd">
                            <div class="weui-form-preview__item">
                                ...
                                <em class="weui-form-preview__value">¥<?php echo ncPriceFormat($item['total_price']); ?></em>
                            </div>
                        </div>
                        <div class="weui-form-preview__bd">
                            ...
                            <div class="weui-form-preview__item">
                                ...
                                <span class="weui-form-preview__value"><?php echo $item['purchase_time']; ?></span>
                            </div>
                        </div>
        ...
        <div class="weui-tabbar" id="tab_home">
            ...
            <a href="<?php echo getWapUrl('order','purchase_order'); ?>" class="weui-tabbar__item weui-bar__item_on">
